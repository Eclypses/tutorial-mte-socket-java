...
<div align="center" style="font-size:28pt; font-family:arial; " >
(MTE Core, MKE, MTE Fixed Length) </div>
...
<ol>
<li>Navigate to the root directory of the project (it will contain the directory named "src"). Add the files in the mte-Windows package inside the src/Java directory (including the  "com" directory). Also if on Windows, copy the mtejni.dll file to the root of the project (in the same directory as the .project file) from the mte-Windows lib directory. If using linux, copy the libmtejni.so file from the mte-Linux lib directory. If using Mac OS, copy the libmtejni.dylib file from the mte-Darwin lib directory.</li>
<br>
<li>Add "import com.eclypses.mte.*;" to the top of the Server.java and the Client.java files.</li>
<br>
...
Instantiate the MTE Decoder and MTE Encoder by calling that function at the start of your main function, also create entropy and make sure to fill entropy again after calling create encoder:
