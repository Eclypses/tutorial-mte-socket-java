...
Windows Java Socket Tutorial</div>
...
<ol>
<li>Add the files in the mte-Windows package inside the src/Java folder (should be “com” folder). Also copy the mtejni.dll file to the root of the project (in the same folder as the .project file) from the mte-Windows lib folder.</li>
<br>
